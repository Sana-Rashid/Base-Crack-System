    ...
    def magic_mode(self, encoded_base):
        ...
        while True:
            if self.decode(encoded_base) is not None:
                ...
                print(colored('\n[-] Encoding Base Found: ', 'yellow')+colored(encoding_scheme, 'green'))
...
╚═════╝ ╚═╝  ╚═╝╚══════╝╚══════╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝
    '''
    print(colored(banner, 'cyan')+colored('\n\t\t\n', 'green'))
...
def main():
    ...
    if args.file:
        ...
        print(colored('[-] Encoded Base: ', 'whites')+colored(str(args.base), 'red'))
        ...
        if sys.version_info >= (3, 0):
            encoded_base = input(colored('[>] Enter Encoded Base: ', 'magenta'))
        else:
